...
seoTitle: "COALESCE vs IFNULL vs NULLIF in BigQuery"
seoDescription: "COALESCE takes N args; IFNULL only two; NULLIF returns NULL when both args match. Side-by-side examples and a guide for choosing the right NULL function."
